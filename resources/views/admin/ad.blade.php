                ...
                <div class="row">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Reklamy</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-5 align-self-center">
                        <div class="customize-input float-end">
                            <a class="btn waves-effect waves-light btn-rounded btn-primary" href="{{ route('admin.forms.category') }}">Nowa reklama</a>
                        </div>
                    </div>
                </div>
            </div>
